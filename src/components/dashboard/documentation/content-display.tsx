                        ...
                        <React.Fragment key={item.id}>
                            ...
                            <BreadcrumbItem>
                                {index === path.length - 1 ? (
                                    ...
                                    <BreadcrumbLink asChild>
                                        <Link href={`/dashboard/documentation?${createQueryString('folderId', item.id)}`}>{item.name}</Link>
                                    </BreadcrumbLink>
                                )}
                            </BreadcrumbItem>
                        </React.Fragment>
                        ...
                        {currentItems.length > 0 ? (
                            currentItems.map(item => (
                                <TableRow key={item.id} className="cursor-pointer" onDoubleClick={() => {
                                    if(item.type === 'folder') {
                                       router.push(`/dashboard/documentation?${createQueryString('folderId', item.id)}`)
                                    } else {
