    ...
    <div className="w-full h-full flex flex-col space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Define a new role and its base permissions.</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col sm:flex-row gap-4">
          ...
          />
          <Button onClick={handleCreateRole} disabled={isSubmitting} className="w-full sm:w-auto">
